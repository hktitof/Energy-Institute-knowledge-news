export default async function handler(req, res) {
    ...
    const { categoryName = "", articles, maxWords = 50, customPrompt = "Create a single, concise summary of these {categoryName} articles in exactly {maxWords} words. Focus on the most important points. Return ONLY the summary text without any formatting or prefixes." } = req.body;
