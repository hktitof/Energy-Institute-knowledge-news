...
const ArticleFetchProgress = ({ totalArticles, fetchedCount, errorCount, currentArticle, isActive, }) => {
    if (!isActive)
        return null;
    return (<div className="mt-2  rounded-md p-3 bg-gray-50">
